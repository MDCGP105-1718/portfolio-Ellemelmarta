...
def freq_dict(lyrics_check):
    ...
    for x in lyrics_check:
        most.append(lyrics_check.count(x))
    return most
#makes a list of words next to their number
print (freq_dict(lyrics_check))
...
#Found .strip code at decalge.info and this helps to remove the [] from the list created and print just the number
